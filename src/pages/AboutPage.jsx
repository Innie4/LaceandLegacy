...
const AboutPage = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-black mb-8">About Lace & Legacy</h1>
      
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-black mb-4">Our Story</h2>
        <p className="text-gray-700 leading-relaxed">
          Lace & Legacy is your premier destination for vintage-inspired t-shirts that capture the essence of bygone eras. 
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          but also stand the test of time. Our commitment to quality ensures that each Lace & Legacy becomes a 
