...
const AboutPage = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-amber-800 mb-8">About ThrowbackTee</h1>
      
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Our Story</h2>
        <p className="text-gray-600 leading-relaxed">
          ThrowbackTee is your premier destination for vintage-inspired t-shirts that capture the essence of bygone eras. 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Quality Promise</h2>
        <p className="text-gray-600 leading-relaxed">
          We use premium materials and sustainable manufacturing processes to create t-shirts that not only look great 
          but also stand the test of time. Our commitment to quality ensures that each ThrowbackTee becomes a 
